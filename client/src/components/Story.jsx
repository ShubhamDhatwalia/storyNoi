...
function Story() {
    ...
    return (
        <>
            <div className="bg-[url('./assets/create-story-bg.png')] sm:py-[160px] py-[80px] sm:pb-[160px] pb-[165px]  bg-no-repeat bg-center bg-cover relative">
                ...
                <div className="container">
                    <div className='bg-[#F6F6F6] h-[100vh]  p-[15px] pb-[0px] lg:py-[70px] rounded-[22px] relative z-10'>
                        <div id='story'
                            ref={scrollRef}
