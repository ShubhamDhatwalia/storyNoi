...
function Story() {
    ...
    return (
        <>
            <div className="bg-[url('./assets/create-story-bg.png')] md:py-[160px] py-[80px] bg-no-repeat bg-center bg-cover relative">
                ...
                <div className="container">
                    <div className='bg-[#F6F6F6] sm:h-[100vh] h:[100vh] p-[15px] lg:py-[70px] rounded-[22px] relative z-10'>
                        <div id='story'
                            ref={scrollRef}
